...
<body>
		...
		<div id="page-wrapper">
			...
			<div class="row">
				<div class="col-md-2 col-xs-12">
					<h4 class="box-title">
						<a href="#addRoomModal" role="button"
							class="btn btn-lg btn-success" data-toggle="modal"
							style="box-shadow: 0px 4px 8px #888888"> ADD ROOM </a>
					</h4>
				</div>
			</div>

			<div id="successNotificationDiv"
					...
					<div class="modal-content">
						...
						<div class="modal-body">
							<div class="row" style="margin-bottom: 5px">
								<div class="col-md-4 col-xs-12">
									<label>Room Code</label> <input type="text"
										class="form-control input-sm" id="roomCode" name="roomCode"
										value="">
								</div>
								<div class="col-md-4 col-xs-12">
							...
							<div class="modal-footer">
								<button type="button" id="btnSave" onclick="saveNewRoom()"
			...
			<div id="deleteModal" class="modal fade">
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-footer">
							<button type="button" class="btn btn-lg btn-block btn-danger" id="btnDelete" onclick="deleteRoom()">Delete</button>
    ...
    function saveNewRoom() {
    	...
    	$.ajax({
    		type: 'POST',
    		url: 'addNewRoom',
    		data: {'roomCode':roomCode, 'name':name},
    		async: true,
    		success: function(result) {
    			addNewRoomToTable(roomCode);
    			$('#addRoomModal').modal('toggle'); // anu to?
    			$('#successNotificationDiv').css('display','block');
    			$('#successNotificationMessage').text("Successfully added new room!");
    		},
    ...
    function addNewRoomToTable(roomCode) {
    	$.ajax({
    		type: 'POST',
    		...
    		async: true,
    		success: function(result) {
    			var row = '<tr id="roomCode' + result.id + '" >'
